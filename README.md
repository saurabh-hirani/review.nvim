...
- **Scope review to its own sessions** ([#10](https://github.com/saurabh-hirani/review.nvim/pull/10)) — review only attaches its hooks/keymaps to codediff sessions it opened via `:Review`; a bare `:CodeDiff` stays plain codediff (no comment keymaps or help popup bolted on)
