...
- **Bring your own comment types** ([#11](https://github.com/saurabh-hirani/review.nvim/pull/11)) — the headline overhaul of this fork. Upstream's built-in types, their keymaps, and their colours are all removed. The plugin now ships nothing by default and hands every construct to you:
