...
local function show_help()
  ...
  entry("send_tmux", "Send to tmux", action_entries)
  entry("send_herdr", "Send to herdr", action_entries)
...
local function set_buffer_keymaps(bufnr)
  ...
  if readonly then
    ...
    set(km.readonly_delete_multi, function() comments.delete_multi() end, "Delete comments (multi-select)")
    ...
    set(km.send_tmux, function() export.to_tmux() end, "Send to tmux")
    set(km.send_herdr, function() export.to_herdr() end, "Send to herdr")
